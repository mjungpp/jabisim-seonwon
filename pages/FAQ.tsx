...
import { ChevronDown, MessageCircle, Sparkles, CheckCircle2, MapPin, ExternalLink } from 'lucide-react';
...
const MIND_LAW_FAQ_DATA: FaqItem[] = [
  {
    ...
    answer: (
      <div className="space-y-3 text-main-textLight">
        <p>
          자비심선원은<br />
          구로자비부처님께서 내려주신 <strong className="text-main-text font-medium">마음법</strong>을 배우는 곳입니다.
        </p>
    ...
    answer: (
      <div className="space-y-3 text-main-textLight">
        <p>
          마음법은<br />
          보이는 결과를 바꾸기 이전에,<br />
          그 결과를 만들어내는 <strong className="text-main-text font-medium">보이지 않는 구조</strong>를 다루는 공부입니다.
        </p>
        <p>
          내 삶을 움직이는 <strong className="text-main-text font-medium">기운의 흐름</strong>을 알고,<br />
          그 방향을 <strong className="text-main-text font-medium">전환하는 법</strong>을 배우는 가르침입니다.
        </p>
      </div>
    )
  },
  {
    ...
    answer: (
      <div className="space-y-3 text-main-textLight">
        <p>
          경전을 해석하거나 이론을 배우는 공부가 아니라,<br />
          <strong className="text-main-text font-medium">지금 내 삶에 직접 적용하는 공부</strong>입니다.
        </p>
        <p>
          삶이 왜 반복되고, 왜 막히는지<br />
          그 <strong className="text-main-text font-medium">근본 원인</strong>을 다루는 데 중심을 둡니다.
        </p>
      </div>
    )
  },
  {
    ...
    answer: (
      <div className="space-y-3 text-main-textLight">
        <p>
          마음법은 단순히 불교를 공부하거나 믿는 것이 아닙니다.
        </p>
        <p className="text-sm bg-main-bgAlt p-3 rounded-lg border border-main-border/50 text-main-textLight/90">
            우리의 <strong>‘진짜 성공과 행복’</strong>을 찾을 수 있도록<br />
            부처님께서 처음 내려주신 가르침(法)을 배우는 공부입니다.
        </p>
        <p className="font-medium text-main-text">
          자신의 인생을 전환하는 것을 목표로 합니다.
        </p>
      </div>
    )
  },
  {
    ...
    answer: (
      <div className="space-y-3 text-main-textLight">
        ...
        <p>
          겉으로 보이는 상황이 아니라<br />
          <strong className="text-main-text font-medium">삶을 움직이는 근본</strong>을 바로 세우는 공부를 합니다.
        </p>
      </div>
    )
  },
  {
    ...
    answer: (
      <div className="space-y-3 text-main-textLight">
        <p>
          공부는 크게 두 가지 흐름의 법회를 통해 이루어집니다.
        </p>
        <ul className="list-disc pl-5 space-y-1 marker:text-main-button">
            <li><strong>정화 축원 법회</strong>(좌명 대선사님 주관): 기운을 정화하고,</li>
            <li><strong>공부 법회</strong>(심진 선생님 주관): 이치를 배우고 현실 적용법을 익힙니다.</li>
        </ul>
        <p>
          법회에 참석하여 기운을 정화하고, 가르침을 배우며,<br />
          이를 삶에 적용해 나가는 구조입니다.
        </p>
      </div>
    )
  },
  {
    ...
    answer: (
      <div className="space-y-3 text-main-textLight">
        ...
        <p className="text-sm bg-main-bgAlt p-3 rounded-lg border border-main-border/50 text-main-textLight/90">
            변화는 겉에서 억지로 만드는 것이 아니라,<br />
            <strong>근본이 바뀌면서 자연스럽게 나타납니다.</strong>
        </p>
      </div>
    )
  }
...
const VISIT_FAQ_DATA: FaqItem[] = [
  {
    ...
    answer: (
      <div className="space-y-3 text-main-textLight">
        <p>법회 신청글은 법회 이틀 전 오후 12시에 ‘법회신청’ 게시판에 올라옵니다.<br/>
        신청서를 작성하시면 법회 신청이 완료됩니다.</p>
        <p className="text-sm bg-main-bgAlt p-3 rounded-lg border border-main-border/50 text-main-textLight/90">
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-3 text-main-textLight">
        <p>사전 신청은 <strong>법회 전날 오후 9시 30분</strong>에 마감됩니다.</p>
        <p>신청을 못하신 분들은 당일 방문 후 말씀해주시면<br/>
        입실하실 수 있도록 안내해드립니다.</p>
      </div>
    )
  },
  {
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-3 text-main-textLight">
        <p>사랑법회는 성인을 위한 대중법회이므로<br/>
        현재 <strong>만 20세 이상만 참석 가능</strong>합니다.</p>
      </div>
    )
  },
  {
    ...
    answer: (
      <div className="space-y-3 text-main-textLight">
        <ul className="list-disc pl-5 space-y-2 marker:text-main-button">
          <li>법회 중 <strong>사진촬영, 녹음, 녹화</strong>는 불가합니다.</li>
          <li>법회 중 <strong>음식이나 음료 섭취</strong>는 어렵습니다.</li>
          <li>대중법회이므로 법회 중 <strong>퇴실은 제한</strong>됩니다.</li>
...
const FAQ: React.FC = () => {
  ...
  const renderFaqList = (data: FaqItem[], prefix: string, iconType: 'sparkles' | 'check') => {
    return (
          ...
          return (
            <div 
              ...
              className={`bg-white rounded-xl overflow-hidden border transition-colors ${
                isOpen ? 'border-main-button/50 shadow-warm' : 'border-main-border shadow-sm'
              }`}
            >
              <button
              ...
              >
                <div className="flex items-start gap-3">
                  <Icon className={`mt-1 flex-shrink-0 ${isOpen ? 'text-main-button' : 'text-gray-300'}`} size={20} />
                  <span className={`font-medium text-lg leading-snug ${isOpen ? 'text-main-buttonHover' : 'text-main-text'}`}>
                    {item.question}
                  </span>
                </div>
                <ChevronDown 
      ...
      <div className="bg-main-bg py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <h1 className="font-serif text-3xl md:text-4xl font-bold text-main-text mb-4">자주 묻는 질문</h1>
          ...
          <div className="mb-10 flex items-center justify-center gap-2">
            ...
            <div className="flex items-center gap-2 text-main-text">
                ...
                <h2 className="text-2xl font-serif font-bold">마음법 · 공부 FAQ</h2>
            </div>
            <div className="h-px bg-main-border w-12 md:w-24"></div>
          </div>
          ...
          <div className="mt-20 mb-10 flex items-center justify-center gap-2">
            ...
            <div className="flex items-center gap-2 text-main-text">
                ...
                <h2 className="text-2xl font-serif font-bold">방문 · 참석 안내 FAQ</h2>
            </div>
            <div className="h-px bg-main-border w-12 md:w-24"></div>
          </div>
          ...
          <div className="mt-16 text-center p-8 bg-main-section rounded-2xl border border-main-border">
            ...
            <h3 className="font-bold text-main-text mb-2">실질적인 방문 절차가 궁금하신가요?</h3>
