      ...
      <div className="bg-main-bg py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="font-serif text-3xl md:text-4xl font-bold text-main-text mb-8">
              오시는 길
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-16">
            <div className="bg-white p-6 rounded-2xl shadow-warm border border-main-border hover:shadow-lg transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg text-main-text mb-3">
                    지하철 이용 시
                  </h3>
                  <p className="text-main-textLight leading-relaxed">
                    <span className="inline-block font-bold text-white bg-[#0052A4] px-2 py-0.5 rounded text-xs mr-2 align-middle">
                      1호선
                    </span>
                    오산대역 1번 출구
                    <br />
            ...
            <div className="bg-white p-6 rounded-2xl shadow-warm border border-main-border hover:shadow-lg transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-main-textLight font-medium mb-2">
                    수청근린공원역 하차
                  </p>
                  <div className="flex flex-wrap gap-2 text-sm">
                    <span className="bg-gray-100 text-gray-600 px-2.5 py-1 rounded font-medium">
                      8
                    </span>
                    <span className="bg-gray-100 text-gray-600 px-2.5 py-1 rounded font-medium">
                      32
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-main-textLight text-sm">
                    <li className="flex items-start gap-2">
                      <span className="font-bold text-main-text min-w-[32px]">
                        KTX
                      </span>
